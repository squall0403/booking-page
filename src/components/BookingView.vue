<template>
  <div class="booking-container">
    ...
    <p><strong>Address</strong>: 22 Đ. Số 68 - TML, Phường Thạnh Mỹ Lợi, Thủ Đức, Thành phố Hồ Chí Minh, Vietnam</p>
    <div class="address-link">
      <img src="../assets/pin.svg"></img>
      <p><a href="https://maps.app.goo.gl/Jh2TsSAPk5LzwA3N9">View direction</a></p>
    </div>
    <hr />
...
.booking-container .address-link{
  display: flex;
  align-items: center;
  gap: 8px;
}

.booking-container .address-link p{
  margin-bottom: 0px;
}
.booking-form {
  display: flex;
